...
public class Cat extends Animal {
    private static final int DEFAULT_MAX_LENGTH_RUN = 200;
    private static final double DEFAULT_MAX_HEIGHT_JUMP = 2.0;
    ...
    public Cat(String name, int max_length_run, double max_height_jump) {
