...
public class Dog extends Animal {
    private static final int DEFAULT_MAX_LENGTH_RUN = 500;
    private static final double DEFAULT_MAX_HEIGHT_JUMP = 0.5;
    private static final int DEFAULT_MAX_DISTANCE_SWIM = 10;
    ...
    public Dog(String name, int max_length_run, double max_height_jump, int max_distance_swim) {
